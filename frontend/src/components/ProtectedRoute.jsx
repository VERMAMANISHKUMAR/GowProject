...
// Helper to convert permission objects into a flat array of permission strings.
// For example, if the user has { module: "report", actions: ["View"] },
// we convert that to "view_reports". Similarly for other modules.
